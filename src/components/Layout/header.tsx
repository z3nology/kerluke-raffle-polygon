  ...
  return (
    <>
      <div className="w-full lg:flex hidden items-center justify-between h-[80px]">
        ...
        <div className="px-20 lg:min-w-[1400px] w-full flex items-center justify-between z-0">
          <div className="flex gap-[60px] items-center justify-center">
            ...
            <li
              className={`text-[14px] font-bold text-white uppercase duration-300 transition-all
                border-white list-none border-opacity-10 pr-[30px] hover:text-yellow-200 ${
